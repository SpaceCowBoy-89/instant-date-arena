    ...
    >
      <Card className={`bg-gradient-to-br from-white via-gray-50 to-purple-50/50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900/30 shadow-lg hover:shadow-xl border-2 border-gray-200/50 dark:border-gray-700/30 rounded-3xl overflow-hidden h-full flex flex-col transition-all duration-300 ${disabled ? 'opacity-70 grayscale' : ''} ${isActive ? 'border-romance/50' : 'hover:border-romance/30'}`}>
        <CardContent className="p-4 sm:p-6 flex-1 flex flex-col relative">
          ...
          {/* Active Arena Content */}
          {isActive && (
            <div className="relative z-10 mb-4">
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200/50 dark:border-green-800/30 rounded-xl p-4">
                <div className="flex items-center justify-center gap-2 mb-3">
                  <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-sm font-bold text-green-700 dark:text-green-300">LIVE NOW</span>
                  <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                </div>

                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div className="text-center">
                    <div className="text-lg font-bold text-green-800 dark:text-green-200">⚡</div>
                    <div className="text-xs text-green-700 dark:text-green-300">Fast-Paced</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-green-800 dark:text-green-200">💬</div>
                    <div className="text-xs text-green-700 dark:text-green-300">Real-Time</div>
                  </div>
                </div>

                <div className="text-center">
                  <p className="text-xs text-green-800 dark:text-green-200 font-medium">
                    Join others competing live right now!
                  </p>
                </div>
              </div>
            </div>
