...
const Navbar = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-sm border-t border-border z-50 pb-safe">
      <div className="flex items-center justify-between py-2 px-1 max-w-md mx-auto" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        <Button
          variant={isActive("/lobby") ? "default" : "ghost"}
          size="sm"
          className="flex flex-col items-center gap-0.5 h-auto py-1.5 px-0.5 min-w-0 flex-1 max-w-[20%]"
