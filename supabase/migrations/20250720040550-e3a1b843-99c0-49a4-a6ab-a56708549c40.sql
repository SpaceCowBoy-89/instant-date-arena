-- Insert test chat threads with existing user (assuming current user is 0f54ba57-1aaf-46db-8862-2f967ad64a1b based on console logs)
-- We'll create simple test users first by inserting into auth.users metadata, then reference them in chats

-- First let's just create the chat threads with dummy user IDs that we'll populate with real test data
