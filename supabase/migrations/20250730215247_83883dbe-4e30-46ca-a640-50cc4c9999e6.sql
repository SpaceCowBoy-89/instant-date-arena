-- Update the trigger function to only assign groups after exactly 8 questions
...
BEGIN
  ...
  -- Only proceed if user has answered exactly 8 questions
  IF total_answers < 8 THEN
    RETURN NEW;
  END IF;
